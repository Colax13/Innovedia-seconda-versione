    ...
    <>
      ...
      <section id="cta">
        ...
        <div className="rv" style={{ display: 'flex', justifyContent: 'center', gap: '16px' }}>
          <button onClick={openAnalysisForm} className="ctb" style={{ background: 'none', border: '1px solid rgba(255,255,255,0.1)', cursor: 'pointer' }}>
            RICHIEDI ANALISI
          ...
          <button onClick={openServiceForm} className="ctb" style={{ background: 'none', border: '1px solid rgba(255,255,255,0.1)', cursor: 'pointer' }}>
