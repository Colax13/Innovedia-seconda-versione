  ...
  return (
    <>
      ...
      <section id="cta">
        ...
        <div className="rv">
          <a href="mailto:ludovico@innovedia.it" className="ctb">
            Scrivimi <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M7 17L17 7M17 7H7M17 7v10"/></svg>
          </a>
        </div>
