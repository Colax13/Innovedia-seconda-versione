        ...
        >
            ...
            <div className="p-8 flex flex-col h-full relative z-20">
                ...
                <div className="mt-auto">
                    <h3 className="font-display font-bold text-3xl uppercase text-white mb-3 tracking-tight">
                        {service.title}
                    </h3>
                ...
                >
                    <div className="mb-16 text-center md:text-left flex flex-col md:flex-row justify-between items-center md:items-end border-b border-white/10 pb-12">
                        <div>
                            ...
                            <h2 className="font-display font-bold text-6xl md:text-8xl uppercase text-white tracking-tighter">
                                Servizi
                            </h2>
                        </div>
                                    ...
                                    >
                                        ...
                                        <div className="absolute inset-0 p-8 flex flex-col h-full z-10">
                                            ...
                                            <div className="mt-auto relative">
                                                <h3 className={`
                                                    font-display font-bold text-4xl uppercase leading-none transition-all duration-500 origin-bottom-left
